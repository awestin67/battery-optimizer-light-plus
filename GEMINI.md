...
-   **Release & Git Process:** Kör ALDRIG `git commit` eller `git push`. Användaren sköter ALLTID commits och kör `python release.py` själv för att bygga releases, bumpa version och pusha till GitHub.
