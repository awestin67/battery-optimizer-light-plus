...
from custom_components.battery_optimizer_light.batteries.sonnen.sonnen import SonnenBattery
...
async def test_create_sonnen_battery():
    ...
    with patch("custom_components.battery_optimizer_light.battery_factory.SonnenAPI") as mock_sonnen_api:
